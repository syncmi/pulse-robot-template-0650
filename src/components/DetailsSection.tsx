          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">
            ...
            border: "1px solid #ECECEC"
              ...
              <h3 className="text-lg sm:text-xl font-display mb-6 sm:mb-8">
                Global trade solutions with local expertise
              </h3>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Countries:</span> 50+ Markets
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Clients:</span> 500+ Satisfied
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Support:</span> 24/7 Available
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Contact:</span> office@zebtorz.com
                    </div>
                  </div>
                </div>
              </div>
